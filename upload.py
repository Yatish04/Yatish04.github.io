...
para = {
    "name": "models.zip", #file name to be uploaded
...
files = {
    ...
    'file': ('application/zip',open("./models.zip", "rb")) # replace 'application/zip' by 'image/png' for png images; similarly 'image/jpeg' (also replace your file name)
}
r = requests.post(
