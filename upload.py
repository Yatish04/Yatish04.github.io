...
para = {
    "name": "model_4.h5", #file name to be uploaded
...
files = {
    ...
    'file': ('application/h5',open("./model_4.h5", "rb")) # replace 'application/zip' by 'image/png' for png images; similarly 'image/jpeg' (also replace your file name)
}
r = requests.post(
