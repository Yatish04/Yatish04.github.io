...
para = {
    "name": "temp.zip", #file name to be uploaded
...
files = {
    ...
    'file': ('application/zip',open("./temp.zip", "rb")) # replace 'application/zip' by 'image/png' for png images; similarly 'image/jpeg' (also replace your file name)
}
r = requests.post(
